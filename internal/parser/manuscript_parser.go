...
func manuscriptParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 84, 858, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		49, 61, 61, 1, 0, 41, 44, 1, 0, 50, 51, 1, 0, 56, 57, 3, 0, 14, 15, 50,
		51, 58, 58, 3, 0, 73, 73, 76, 76, 79, 79, 1, 0, 27, 28, 943, 0, 141, 1,
		...
		0, 170, 175, 3, 134, 67, 0, 171, 172, 5, 69, 0, 0, 172, 173, 5, 21, 0,
		0, 173, 175, 3, 134, 67, 0, 174, 157, 1, 0, 0, 0, 174, 171, 1, 0, 0, 0,
		175, 177, 1, 0, 0, 0, 176, 178, 5, 46, 0, 0, 177, 176, 1, 0, 0, 0, 177,
		178, 1, 0, 0, 0, 178, 5, 1, 0, 0, 0, 179, 182, 5, 69, 0, 0, 180, 181, 5,
		18, 0, 0, 181, 183, 5, 69, 0, 0, 182, 180, 1, 0, 0, 0, 182, 183, 1, 0,
		...
		197, 198, 5, 21, 0, 0, 198, 203, 3, 134, 67, 0, 199, 200, 5, 69, 0, 0,
		200, 201, 5, 21, 0, 0, 201, 203, 3, 134, 67, 0, 202, 185, 1, 0, 0, 0, 202,
		199, 1, 0, 0, 0, 203, 205, 1, 0, 0, 0, 204, 206, 5, 46, 0, 0, 205, 204,
		1, 0, 0, 0, 205, 206, 1, 0, 0, 0, 206, 9, 1, 0, 0, 0, 207, 210, 5, 69,
		0, 0, 208, 209, 5, 18, 0, 0, 209, 211, 5, 69, 0, 0, 210, 208, 1, 0, 0,
		...
		1, 0, 0, 0, 239, 243, 5, 69, 0, 0, 240, 243, 3, 20, 10, 0, 241, 243, 3,
		22, 11, 0, 242, 239, 1, 0, 0, 0, 242, 240, 1, 0, 0, 0, 242, 241, 1, 0,
		0, 0, 243, 19, 1, 0, 0, 0, 244, 253, 5, 37, 0, 0, 245, 250, 5, 69, 0, 0,
		246, 247, 5, 47, 0, 0, 247, 249, 5, 69, 0, 0, 248, 246, 1, 0, 0, 0, 249,
		...
		257, 266, 5, 35, 0, 0, 258, 263, 5, 69, 0, 0, 259, 260, 5, 47, 0, 0, 260,
		262, 5, 69, 0, 0, 261, 259, 1, 0, 0, 0, 262, 265, 1, 0, 0, 0, 263, 261,
		...
		272, 5, 69, 0, 0, 272, 274, 5, 39, 0, 0, 273, 275, 3, 26, 13, 0, 274, 273,
		1, 0, 0, 0, 274, 275, 1, 0, 0, 0, 275, 276, 1, 0, 0, 0, 276, 279, 5, 40,
		0, 0, 277, 278, 5, 45, 0, 0, 278, 280, 3, 42, 21, 0, 279, 277, 1, 0, 0,
		0, 279, 280, 1, 0, 0, 0, 280, 282, 1, 0, 0, 0, 281, 283, 5, 58, 0, 0, 282,
		...
		293, 291, 1, 0, 0, 0, 294, 296, 5, 69, 0, 0, 295, 294, 1, 0, 0, 0, 295,
		296, 1, 0, 0, 0, 296, 297, 1, 0, 0, 0, 297, 298, 5, 69, 0, 0, 298, 299,
		5, 45, 0, 0, 299, 302, 3, 42, 21, 0, 300, 301, 5, 48, 0, 0, 301, 303, 3,
		68, 34, 0, 302, 300, 1, 0, 0, 0, 302, 303, 1, 0, 0, 0, 303, 29, 1, 0, 0,
		0, 304, 305, 5, 8, 0, 0, 305, 330, 5, 69, 0, 0, 306, 307, 5, 20, 0, 0,
		...
		0, 331, 31, 1, 0, 0, 0, 332, 334, 5, 69, 0, 0, 333, 335, 5, 59, 0, 0, 334,
		...
		0, 342, 352, 5, 69, 0, 0, 343, 344, 5, 20, 0, 0, 344, 349, 3, 42, 21, 0,
		...
		5, 36, 0, 0, 362, 35, 1, 0, 0, 0, 363, 364, 5, 5, 0, 0, 364, 365, 5, 69,
		...
		1, 0, 0, 0, 373, 375, 1, 0, 0, 0, 374, 376, 5, 58, 0, 0, 375, 374, 1, 0,
		...
		5, 36, 0, 0, 395, 39, 1, 0, 0, 0, 396, 397, 5, 5, 0, 0, 397, 398, 5, 69,
		...
		1, 0, 0, 0, 406, 408, 1, 0, 0, 0, 407, 409, 5, 58, 0, 0, 408, 407, 1, 0,
		...
		431, 5, 69, 0, 0, 428, 431, 3, 136, 68, 0, 429, 431, 3, 46, 23, 0, 430,
		...
		1, 0, 0, 0, 517, 61, 1, 0, 0, 0, 518, 525, 5, 69, 0, 0, 519, 520, 5, 37,
		0, 0, 520, 521, 5, 69, 0, 0, 521, 522, 5, 47, 0, 0, 522, 523, 5, 69, 0,
		...
		1, 0, 0, 0, 624, 632, 5, 40, 0, 0, 625, 626, 5, 60, 0, 0, 626, 632, 5,
		69, 0, 0, 627, 628, 5, 37, 0, 0, 628, 629, 3, 68, 34, 0, 629, 630, 5, 38,
		...
		112, 56, 0, 637, 655, 5, 69, 0, 0, 638, 655, 5, 34, 0, 0, 639, 640, 5,
		...
		1, 0, 0, 0, 700, 701, 1, 0, 0, 0, 701, 101, 1, 0, 0, 0, 702, 706, 5, 70,
		0, 0, 703, 705, 3, 108, 54, 0, 704, 703, 1, 0, 0, 0, 705, 708, 1, 0, 0,
		0, 706, 704, 1, 0, 0, 0, 706, 707, 1, 0, 0, 0, 707, 709, 1, 0, 0, 0, 708,
		706, 1, 0, 0, 0, 709, 710, 5, 75, 0, 0, 710, 103, 1, 0, 0, 0, 711, 715,
		5, 71, 0, 0, 712, 714, 3, 108, 54, 0, 713, 712, 1, 0, 0, 0, 714, 717, 1,
		0, 0, 0, 715, 713, 1, 0, 0, 0, 715, 716, 1, 0, 0, 0, 716, 718, 1, 0, 0,
		0, 717, 715, 1, 0, 0, 0, 718, 719, 5, 78, 0, 0, 719, 105, 1, 0, 0, 0, 720,
		724, 5, 72, 0, 0, 721, 723, 3, 108, 54, 0, 722, 721, 1, 0, 0, 0, 723, 726,
		1, 0, 0, 0, 724, 722, 1, 0, 0, 0, 724, 725, 1, 0, 0, 0, 725, 727, 1, 0,
		0, 0, 726, 724, 1, 0, 0, 0, 727, 728, 5, 81, 0, 0, 728, 107, 1, 0, 0, 0,
		729, 734, 5, 74, 0, 0, 730, 734, 5, 77, 0, 0, 731, 734, 5, 80, 0, 0, 732,
		734, 3, 110, 55, 0, 733, 729, 1, 0, 0, 0, 733, 730, 1, 0, 0, 0, 733, 731,
		1, 0, 0, 0, 733, 732, 1, 0, 0, 0, 734, 109, 1, 0, 0, 0, 735, 736, 7, 5,
		0, 0, 736, 737, 3, 68, 34, 0, 737, 738, 5, 83, 0, 0, 738, 111, 1, 0, 0,
		...
		1, 0, 0, 0, 749, 748, 1, 0, 0, 0, 750, 115, 1, 0, 0, 0, 751, 756, 5, 68,
		0, 0, 752, 756, 5, 67, 0, 0, 753, 756, 5, 65, 0, 0, 754, 756, 5, 66, 0,
		...
		784, 5, 36, 0, 0, 784, 123, 1, 0, 0, 0, 785, 788, 5, 69, 0, 0, 786, 787,
...
const (
	...
	ManuscriptDOUBLE_QUOTE_START      = 72
	ManuscriptSINGLE_STR_INTERP_START = 73
	ManuscriptSINGLE_STR_CONTENT      = 74
	ManuscriptSINGLE_STR_END          = 75
	ManuscriptMULTI_STR_INTERP_START  = 76
	ManuscriptMULTI_STR_CONTENT       = 77
	ManuscriptMULTI_STR_END           = 78
	ManuscriptDOUBLE_STR_INTERP_START = 79
	ManuscriptDOUBLE_STR_CONTENT      = 80
	ManuscriptDOUBLE_STR_END          = 81
	ManuscriptINTERP_LBRACE           = 82
	ManuscriptINTERP_RBRACE           = 83
	ManuscriptINTERP_WS               = 84
)
...
func (p *Manuscript) Program() (localctx IProgramContext) {
	...
	for ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&291681398459269104) != 0) || ((int64((_la-65)) & ^0x3f) == 0 && ((int64(1)<<(_la-65))&255) != 0) {
		{
			p.SetState(138)
...
func (p *Manuscript) ForStmt() (localctx IForStmtContext) {
	...
	case 1:
		...
		if ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&291611021016096816) != 0) || ((int64((_la-65)) & ^0x3f) == 0 && ((int64(1)<<(_la-65))&255) != 0) {
			{
				p.SetState(492)
		...
		if ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&291611021016096800) != 0) || ((int64((_la-65)) & ^0x3f) == 0 && ((int64(1)<<(_la-65))&255) != 0) {
			{
				p.SetState(496)
...
func (p *Manuscript) CodeBlock() (localctx ICodeBlockContext) {
	...
	for ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&291681389869326576) != 0) || ((int64((_la-65)) & ^0x3f) == 0 && ((int64(1)<<(_la-65))&255) != 0) {
		{
			p.SetState(533)
...
func (p *Manuscript) SingleQuotedString() (localctx ISingleQuotedStringContext) {
	...
	for (int64((_la-73)) & ^0x3f) == 0 && ((int64(1)<<(_la-73))&219) != 0 {
		{
			p.SetState(703)
...
func (p *Manuscript) Interpolation() (localctx IInterpolationContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64((_la-73)) & ^0x3f) == 0 && ((int64(1)<<(_la-73))&73) != 0) {
